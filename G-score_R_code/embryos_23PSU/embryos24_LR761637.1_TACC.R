#!/usr/bin/env Rscript
# rm(list = ls())
setwd("/scratch/05301/dewitp/dynamo/R/embryos24/LR761637")
...
OBS_REF <- read.delim("embryos24_LR761637.1_REF.txt", header=TRUE)
OBS_ALT <- read.delim("embryos24_LR761637.1_ALT.txt", header=TRUE)
...
TOTAL <- data.frame(matrix(ncol = 41, nrow = 1728960))
...
Total_G_matrix <- data.frame(matrix(ncol = 41, nrow = 532))
Het_G_matrix <- data.frame(matrix(ncol = 41, nrow = 532))
df_matrix <- data.frame(matrix(ncol = 41, nrow = 532))
