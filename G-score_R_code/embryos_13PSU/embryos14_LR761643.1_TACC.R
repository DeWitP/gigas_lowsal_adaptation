#!/usr/bin/env Rscript
# rm(list = ls())
setwd("/scratch/05301/dewitp/dynamo/R/LR761643")
...
OBS_REF <- read.delim("embryos14_LR761643.1_REF.txt", header=TRUE)
OBS_ALT <- read.delim("embryos14_LR761643.1_ALT.txt", header=TRUE)
...
TOTAL <- data.frame(matrix(ncol = 39, nrow = 2244249))
...
Total_G_matrix <- data.frame(matrix(ncol = 39, nrow = 576))
Het_G_matrix <- data.frame(matrix(ncol = 39, nrow = 576))
df_matrix <- data.frame(matrix(ncol = 39, nrow = 576))
