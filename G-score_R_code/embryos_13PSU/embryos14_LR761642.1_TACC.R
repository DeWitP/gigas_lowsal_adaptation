#!/usr/bin/env Rscript
# rm(list = ls())
setwd("/scratch/05301/dewitp/dynamo/R/LR761642")
...
OBS_REF <- read.delim("embryos14_LR761642.1_REF.txt", header=TRUE)
OBS_ALT <- read.delim("embryos14_LR761642.1_ALT.txt", header=TRUE)
...
TOTAL <- data.frame(matrix(ncol = 39, nrow = 1052510))
...
Total_G_matrix <- data.frame(matrix(ncol = 39, nrow = 371))
Het_G_matrix <- data.frame(matrix(ncol = 39, nrow = 371))
df_matrix <- data.frame(matrix(ncol = 39, nrow = 371))
