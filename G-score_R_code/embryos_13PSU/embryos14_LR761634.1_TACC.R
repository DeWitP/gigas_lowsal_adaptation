#!/usr/bin/env Rscript
setwd("/scratch/05301/dewitp/dynamo/R/LR761634")
...
OBS_REF <- read.delim("embryos14_LR761634.1_REF.txt", header=TRUE)
OBS_ALT <- read.delim("embryos14_LR761634.1_ALT.txt", header=TRUE)
...
TOTAL <- data.frame(matrix(ncol = 39, nrow = 2209213))
...
Total_G_matrix <- data.frame(matrix(ncol = 39, nrow = 558))
Het_G_matrix <- data.frame(matrix(ncol = 39, nrow = 558))
df_matrix <- data.frame(matrix(ncol = 39, nrow = 558))
