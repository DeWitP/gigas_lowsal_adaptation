#!/usr/bin/env Rscript
# rm(list = ls())
setwd("/scratch/05301/dewitp/dynamo/R/LR761635")
...
OBS_REF <- read.delim("embryos14_LR761635.1_REF.txt", header=TRUE)
OBS_ALT <- read.delim("embryos14_LR761635.1_ALT.txt", header=TRUE)
...
TOTAL <- data.frame(matrix(ncol = 39, nrow = 1060014))
...
Total_G_matrix <- data.frame(matrix(ncol = 39, nrow = 733))
Het_G_matrix <- data.frame(matrix(ncol = 39, nrow = 733))
df_matrix <- data.frame(matrix(ncol = 39, nrow = 733))
